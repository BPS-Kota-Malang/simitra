...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Semua tentang pegaturan</h2>
            <p class="section-lead">
                Kita dapat menyesuaikan semua pengaturan di sini
            </p>
            ...
            <div class="col-md-8">
                {!! Form::open(['url' => 'admin/settings', 'files' => true]) !!}
                    <div class="card" id="settings-card">
                        <div class="card-header">
                            <h4>{{ ucwords($currentCategory) }} Pengaturan</h4>
                        </div>
                        <div class="card-body">
                                ...
                                @if ($setting->setting_type == 'file' && get_setting($setting->setting_key, false))
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-3 col-md-3">
                                            <a href="{{ url('admin/settings/remove/' . $setting->id ) }}" class="btn btn-danger">Hapus</a>
                                        </div>
                                    </div>
                                @endif
                            @endforeach
