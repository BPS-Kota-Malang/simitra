...
class SettingController extends Controller
{
    ...
    public function update(SettingRequest $request)
    {
        ...
        if ($updateSetting) {
            return redirect('admin/settings')->with('success', 'Pengaturan berhasil di update.');
        }

        return redirect('admin/settings')->with('error', 'Beberapa pengaturan tidak dapat di udpate.');
    }
